...
public class ClientFlowTest {
    ...
    public void testBuilderAPI() throws Exception {
        ...
        assertJmxValue(oNameCB, "CallTimeout", "12000 milliseconds");
        assertJmxValue(oNameCB, "ResetTimeout", "780000 milliseconds");
        assertJmxValue(oNameCB, "MaxResetTimeout", "1209600000 milliseconds");
