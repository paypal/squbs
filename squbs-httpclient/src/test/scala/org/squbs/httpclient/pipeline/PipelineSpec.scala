...
class PipelineSpec extends TestKit(ActorSystem("PipelineSpec")) with FlatSpecLike with DummyService with HttpClientTestKit with Matchers with BeforeAndAfterAll with PipelineManager{
