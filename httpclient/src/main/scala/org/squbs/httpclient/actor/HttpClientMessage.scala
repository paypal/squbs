...
import scala.Some
import org.squbs.httpclient.Client
...
object HttpClientManagerMessage {
   ...
   * @param pipeline
   */
  case class CreateHttpClient(name: String,
                              env: Option[String] = None,
                              config: Option[Configuration] = None,
                              pipeline: Option[Pipeline] = None) extends Client
   ...
   * @param env
   */
  case class DeleteHttpClient(name: String,
                              env: Option[String] = None)
   ...
   * @param env
   */
  case class GetHttpClient(name: String, env: Option[String] = None)

  /**
   * Success => TrieMap[(String, Option[String], (Client, ActorRef)])
   */
...
object HttpClientActorMessage {
   ...
   * @param pipeline
   */
  case class Update(config: Option[Configuration] = None,
