...
libraryDependencies ++= Seq(
  ...
  "com.github.pjfanning" %% "pekko-http-json4s" % heikoseebergerAkkaHttpJsonV % Optional,
  "com.github.pjfanning" %% "pekko-http-jackson" % heikoseebergerAkkaHttpJsonV % Optional,
