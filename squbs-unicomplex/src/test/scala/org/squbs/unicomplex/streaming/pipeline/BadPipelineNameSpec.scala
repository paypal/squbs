...
object BadPipelineNameSpec {
  ...
  val classPaths = Array(getClass.getClassLoader.getResource("classpaths/streaming/pipeline/BadPipelineNameSpec").getPath)
  ...
  val config = ConfigFactory.parseString(
    s"""
       ...
       |squbs {
       |  actorsystem-name = streaming-badPipelineNameSpec
