...
public class AskOrchestratorTest extends CustomTestKit {

    public AskOrchestratorTest() {
        super(ConfigFactory.parseString("squbs.external-config-dir = askOrchestratorTestConfig"));
    }
