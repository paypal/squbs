...
public class AbstractCustomTestKitTest extends AbstractCustomTestKit {

    AbstractCustomTestKitTest() {
    ...
    private static class TestConfig {
        ...
        static {
            ...
            configMap.put("squbs.actorsystem-name", "AbstractCustomTestKitTest");
